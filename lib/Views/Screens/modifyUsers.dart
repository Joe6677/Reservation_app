...
import 'package:smart_school_system/Views/Screens/editUser.dart';

class ModifyUsers extends StatefulWidget {
  const ModifyUsers({super.key});

  @override
  State<ModifyUsers> createState() => _ModifyUsersState();
}

class _ModifyUsersState extends State<ModifyUsers> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Edit Users', style: TextStyle(color: Colors.white)),
